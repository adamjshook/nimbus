...
public class NimbusMapBenchmark extends Configured implements Tool {

	private static final Logger LOG = Logger.getLogger(NimbusMapBenchmark.class);
	...
	public int run(String[] args) throws Exception {
		...
		for (FileStatus status : files) {
			...
			if (type.equalsIgnoreCase("nimbus")) {
				NimbusMapBenchmarker benchmarker = new NimbusMapBenchmarker();
	...
	public static void main(String[] args) throws Exception {
		ToolRunner.run(new Configuration(), new NimbusMapBenchmark(), args);
	}
}
